...
std::map<PanelIndex, CfgDefaults> PluginCfg::def = {\
		...
		{0,MF2,MF3Rules,MF4,MEmptyString,MF6Routes6,MEmptyString,MF8Routes,0,0,0,0},
		#else
		{{L"to", L"via", L"dev", L"prefsrc", L"proto", L"expire", 0}, {L"to", L"via", L"dev", L"prefsrc", L"proto", L"expire", 0}},
		{0,MF2,MEmptyString,MF4,MEmptyString,MF6Routes6,MEmptyString,MF8Routes,0,0,0,0},
		#endif
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		#if !defined(__APPLE__) && !defined(__FreeBSD__)
		{{L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}, {L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}},
		{0,MF2,MF3Rules,MF4,MEmptyString,MF6RoutesArp,MEmptyString,MF8Routes,0,0,0,0},
		#else
		{{L"to", L"via", L"dev", L"prefsrc", L"proto", L"expire", 0}, {L"to", L"via", L"dev", L"prefsrc", L"proto", L"expire", 0}},
		{0,MF2,MEmptyString,MF4,MEmptyString,MF6RoutesArp,MEmptyString,MF8Routes,0,0,0,0},
		#endif
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		#if !defined(__APPLE__) && !defined(__FreeBSD__)
		{0,MF2,MEmptyString,MF4,MEmptyString,MF6McRoutes,MEmptyString,MF8Routes,0,0,0,0},
		#else
		{0,MF2,MEmptyString,MF4,MEmptyString,MF6Routes,MEmptyString,MF8Routes,0,0,0,0},
		#endif
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		{{L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}, {L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}},
		{0,MF2,MF3Rules,MF4,MEmptyString,MF6McRoutes6,MEmptyString,MF8Routes,0,0,0,0},
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		{L"29,16,7,17,0,0", L"29,16,7,17,0,0"},
		{{L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}, {L"to", L"via", L"dev", L"prefsrc", L"proto", L"metric", 0}},
		{0,MF2,MF3Rules,MF4,MEmptyString,MF6Routes,MEmptyString,MF8Routes,0,0,0,0},
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		{0,MF2,MF3Routes,MF4,MEmptyString,MF6Next,MEmptyString,MF8Routes,0,0,0,0},
		{MEmptyString,MEmptyString,MEmptyString,MF4Create,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString,MEmptyString},
		...
		{0,MF2,MF3Rules,MEmptyString,MEmptyString,MF6Next,MEmptyString,MEmptyString,0,0,0,0},
